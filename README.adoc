...
* The modified XML sources are automatically formatted on each pull request. If you still want to format them manually locally,
use the following command:

`$ xmlformat -d /etc/daps/docbook-xmlformat.conf -i <MODIFIED_DOCBOOK_FILE>`
